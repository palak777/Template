...
.bgimg {
    ...
    background-image: url("/vendor/images/pizza.jpg");
    min-height: 90%;
}
</style>
<body>
...
<div class="w3-container w3-padding-64 w3-red w3-grayscale w3-xlarge" id="about">
  <div class="w3-content">
    ...
    <p><strong>The Chef?</strong> Mr. Italiano himself<img src="/vendor/images/chef.jpg" style="width:150px" class="w3-circle w3-right" alt="Chef"></p>
    <p>We are proud of our interiors.</p>
    <img src="/vendor/images/onepage_restaurant.jpg" style="width:100%" class="w3-margin-top w3-margin-bottom" alt="Restaurant">
